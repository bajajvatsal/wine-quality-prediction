...
# %% [markdown]
#  Counting, unique values in the qality feature of the dataset
...
# %% [markdown]
#  According to the above graph, it is obvious that the target feauture "quality" is highly baised so we had to do over-sampling or undersampling.<br>And since the data is limited we had to do oversampling.
# %% [markdown]
#  ## Data Preprocessing
# %% [markdown]
...
# %% [markdown]
#  ### Oversampling
#   Since we know that the data is highly baised on some values in the quality feature, we are using oversampling method to solve this problem
...
# %% [markdown]
#  ## Model Training
#  Using many differernt ML models from linear regressro to xgboost regresspr
# 
# %% [markdown]
# ### Linear Regressor
